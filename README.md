...
```shell
wget https://drive.yangwn.top/d/AliDrive/Linux/Docker/Zabbix/images/zabbix-image-4.0.tar.gz
...
Starting Zabbix Server. Zabbix 4.0.1 (revision a80cb13).
Press Ctrl+C to exit.
     8:20220313:155643.869 Starting Zabbix Server. Zabbix 4.0.1 (revision a80cb13).
   ...
   208:20220313:155644.937 HA manager has been stopped
     8:20220313:155644.938 Zabbix Server stopped. Zabbix 4.0.1 (revision a80cb13).
